...
const containerStyle = { display: 'flex', justifyContent: 'space-between', flexDirection: 'column', marginBottom: '20px' }
const userContainer = { textAlign: 'right' }
const agentContainer = { textAlign: 'left' }
const userStyle = {
	maxWidth: '50%',
	textAlign: 'left',
